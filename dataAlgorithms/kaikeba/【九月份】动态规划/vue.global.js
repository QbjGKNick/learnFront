  ...
  */
  ...
  function baseCreateRenderer(options, createHydrationFns) {
    ...
    const patchKeyedChildren = (
      ...
      // step1和2是vue diff的双向查找
      //* 1. sync from start 从左边查找，如果节点不能复用，则停止
      // (a b) c
      // (a b) d e
      while (i <= e1 && i <= e2) {
        const n1 = c1[i]
      ...
      // * 2. sync from end 从右边查找，如果节点不能复用，则停止
      // a (b c)
      // d e (b c)
      while (i <= e1 && i <= e2) {
        const n1 = c1[e1]
      ...
      // * 3. common sequence + mount 老节点没了，新节点有,新增
      // (a b)
      // (a b) c
      // i = 2, e1 = 1, e2 = 2
      // (a b)
      ...
      // * 4. common sequence + unmount 老节点有，新节点没了，删除
      // (a b) c
      // (a b)
      // i = 2, e1 = 2, e2 = 1
      // a (b c)
      ...
      // * 5. unknown sequence  新老节点都有，但是顺序不稳定
      ...
      // i = 2, e1 = 4, e2 = 5
        ...
        // 把新节点做成key value的map图
        const keyToNewIndexMap = new Map()
        // 遍历新节点数组了，做个map图 key
        // 为什么做map图，因为他想通过key快速获取到节点
        for (i = s2; i <= e2; i++) {
          const nextChild = (c2[i] = optimized
            ? cloneIfMounted(c2[i])
            : normalizeVNode(c2[i]))
        ...
        // 新节点下标
        let patched = 0
        // 前面已经对老节点进行了双向查找，双向查找完毕只会，剩下了“有点乱的”中间节点部分
        // e2是中间老节点的尾结点下标，s2是头结点下标
        ...
        // 遍历老节点
        // old _0 _1 _2 _3 4 array vdom
        // new 1 3 2 5 array vdom map
        for (i = s1; i <= e1; i++) {
        ...
        // old 1 2 3 4
        // new 1 3 2 5
        // 那么此时 dom中也就是老节点中的1 2 就是最长的稳定序列之一
